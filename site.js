...
parts = {
  lng: !isNaN(parts[0] && parts[0]) ? parseFloat(parts[0]).toFixed(6) : 39.2832471,
  lat: !isNaN(parts[1] && parts[1]) ? parseFloat(parts[1]).toFixed(6) : -6.81390,
  zoom: !isNaN(parts[2] && parts[2]) ? parts[2] : 14,
};
...
var layers = [
  ...
  { title: 'Today', fill: '#ff9433', layer: 'allryder.79669c73', },
  { title: 'Today', fill: '#ff9433', layer: 'allryder.79669c73' }
